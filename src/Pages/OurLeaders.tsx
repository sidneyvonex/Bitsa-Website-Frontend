...
export const OurLeaders = () => {
    ...
    const currentLeaders = useMemo(() => {
        ...
        if (Array.isArray(currentData.data?.leaders)) return currentData.data.leaders;
        return [];
    }, [currentData]);
    ...
    const pastLeaders = useMemo(() => {
        ...
        if (Array.isArray(pastData.data?.leaders)) return pastData.data.leaders;
        return [];
    }, [pastData]);
            ...
            <main className="min-h-screen bg-gray-50 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <section className="mb-16">
                        ...
                        {isErrorCurrent && (
                            <div className="flex flex-col gap-2 bg-red-50 border border-red-100 text-red-700 px-4 py-3 rounded-2xl mb-8">
                                ...
                                {currentError && (
                                    <p className="text-sm mt-2">Error: {JSON.stringify(currentError)}</p>
                                )}
                            </div>
                        )}
