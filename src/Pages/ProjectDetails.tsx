...
import { ArrowLeft, Github, User, Calendar, Code2, ExternalLink, RefreshCw } from 'lucide-react';
...
export const ProjectDetails = () => {
  ...
  const authorName = project ? `${project.authorFirstName} ${project.authorLastName}` : '';
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-10">
            ...
            <div className="flex items-center gap-4 mb-8 pb-8 border-b border-gray-200">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">{project.authorSchoolId}</p>
                <p className="text-sm text-gray-500">{project.authorEmail}</p>
              </div>
            </div>
